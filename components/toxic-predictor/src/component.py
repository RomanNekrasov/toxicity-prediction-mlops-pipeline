...
def calculute_metrics_and_save(y, y_pred, average_var, metrics_path):
    metrics = {
...
def predict_multilabel_classifier(project_id, predict_data, model_repo, metrics_path, validation_data):
    ...
    if validation_data:
        ...
        micro_metrics = calculute_metrics_and_save(y_all, y_pred, 'micro', metrics_path)
        macro_metrics = calculute_metrics_and_save(y_all, y_pred, 'macro', metrics_path)
